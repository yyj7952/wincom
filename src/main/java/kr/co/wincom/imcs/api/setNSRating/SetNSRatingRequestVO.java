...
public class SetNSRatingRequestVO  extends NoSqlLoggingVO implements Serializable {
	/********************************************************************
	...
	********************************************************************/
    ...
    public SetNSRatingRequestVO(){}
    
    public SetNSRatingRequestVO(String szParam){
		...
		//SetNSRatingController.saId = paramMap.get("sa_id");
		
		//SetNSRatingController.stbMac = paramMap.get("stb_mac");
		
		if( paramMap.get("sa_id") == null || paramMap.get("stb_mac") == null
				|| paramMap.get("rating") == null )
		{
			throw new ImcsException();
		}
