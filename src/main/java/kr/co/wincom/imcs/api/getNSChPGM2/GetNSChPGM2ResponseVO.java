...
public class GetNSChPGM2ResponseVO implements Serializable {
	/********************************************************************
...
//    private String linkUrl		= "";	// 웹사이트링크 URL
	...
	********************************************************************/
    ...
    public String toString(){
		...
		sb.append(StringUtil.nullToSpace(this.mainProperty)).append(ImcsConstants.COLSEP);
		sb.append(StringUtil.nullToSpace(this.subProperty.replaceAll("\\\\b", ImcsConstants.ARRSEP))).append(ImcsConstants.COLSEP);
    	...
    	for(int j = 0; j < arrRowResult.length; j++)
		{
			switch(j)
			{
				case 0:
					...
					break;
				case 1:
					this.setEpgType(arrRowResult[j]);
					break;
				case 2:
					this.setServiceId(arrRowResult[j]);
					break;
				case 3:
					this.setChnlNm(arrRowResult[j]);
					break;
				case 4:
					this.setProgramId(arrRowResult[j]);
					break;
				case 5:
					this.setEventId(arrRowResult[j]);
					break;
				case 6:
					this.setProgramTitle(arrRowResult[j]);
					break;
				case 7:
					this.setDuplGb(arrRowResult[j]);
					break;
				case 8:
					this.setCategoryId(arrRowResult[j]);
					break;
				case 9:
					this.setGenre1(arrRowResult[j]);
					break;
				case 10:
					this.setGenre2(arrRowResult[j]);
					break;
				case 11:
					this.setStartTime(arrRowResult[j]);
					break;
				case 12:
					this.setEndTime(arrRowResult[j]);
					break;
				case 13:
				...
				case 14:
					...
					break;
				case 15:
					this.setVirtualId(arrRowResult[j]);
					break;
				case 16:
					this.setRuntime(arrRowResult[j]);
					break;
				case 17:
					this.setPrInfo(arrRowResult[j]);
					break;
				case 18:
					this.setSubChnlYn(arrRowResult[j]);
					break;
				case 19:
					this.setLiveYn(arrRowResult[j]);
					break;
				case 20:
					this.setFilteringCode(arrRowResult[j]);
					break;
				case 21:
					this.setMainProperty(arrRowResult[j]);
					break;
				case 22:
					this.setSubProperty(arrRowResult[j]);
					break;
				default:
					break;
			}
