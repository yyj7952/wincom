...
public class GetNSPeriodRequestVO  extends NoSqlLoggingVO implements Serializable {
	/********************************************************************
	...
	********************************************************************/
    ...
    public GetNSPeriodRequestVO(){}
    
    public GetNSPeriodRequestVO(String szParam){
		...
		for(int i = 0; i < arrStat.length; i++){
			...
			if(nStr > 0) {
				...
				if(key.toLowerCase().equals("category_gb"))		this.catGb = value;
			}
		}
		
		//GetNSPeriodController.saId = paramMap.get("sa_id");
		
		//GetNSPeriodController.stbMac = paramMap.get("stb_mac");
		
		if( paramMap.get("sa_id") == null || paramMap.get("stb_mac") == null
				|| paramMap.get("cat_gb") == null  )
		{
			throw new ImcsException();
		}
