...
public class GetNSPurchasedTest
{
   ...
   @Test
   public void test_getNSPurchased() throws Exception
   {
	   test_run("getNSPurchasedTestCase_all.xlsx", "log/getNSPurchasedTestCase_all.log");
   }
   ...
   public void test_run(String preadFilePath, String  pwriteFilePath, int iRowNo ) throws Exception
   {
	   ...
	   for( int rowindex = 0 ; rowindex < rows; rowindex++){
	       ...
	       if( rowindex == 0 ){
	    	   ...
	    	   request.param("CMD", "getNSPurchased");
	           for( int columnindex = 0; columnindex < cells; columnindex++ ){
	        	   String value = rowCellValue(row, columnindex);
	               if( columnindex == 0 ){
	            	   caseTitle = value;
...
//				assertThat(mvcResult.getResponse().getContentAsString(), startsWith(caseResult));
				...
				logBuffer.append("=========== getNSPurchased " + caseTitle + " start!! ==========" + "\r\n");
				...
				logBuffer.append("=========== getNSPurchased " + caseTitle + " end!! ==========" + "\r\n\r\n");
