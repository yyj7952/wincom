...
public class GetNSCHListsTest
{
   ...
   @Test
   public void test_getNSCHLists() throws Exception
   {
	   test_run("getNSCHListsTestCase_all.xlsx", "log/getNSCHListsTestCase_all.log");
   }
   ...
   public void test_run(String preadFilePath, String  pwriteFilePath, int iRowNo ) throws Exception
   {
	   ...
	   for( int rowindex = 0 ; rowindex < rows; rowindex++){
	       ...
	       if( rowindex == 0 ){
	    	   ...
	    	   request.param("CMD", "getNSCHLists");
	           for( int columnindex = 0; columnindex < cells; columnindex++ ){
	        	   String value = rowCellValue(row, columnindex);
	               if( columnindex == 0 ){
	            	   caseTitle = value;
...
//				assertThat(mvcResult.getResponse().getContentAsString(), startsWith(caseResult));
				...
				logBuffer.append("=========== getNSCHLists " + caseTitle + " start!! ==========" + "\r\n");
				...
				logBuffer.append("=========== getNSCHLists " + caseTitle + " end!! ==========" + "\r\n\r\n");
