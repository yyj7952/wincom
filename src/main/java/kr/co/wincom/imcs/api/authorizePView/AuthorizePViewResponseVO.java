...
public class AuthorizePViewResponseVO implements Serializable
{
	private static final long serialVersionUID = 170116096565178079L;
	
	private String flag						= "";		// 성공여부 코드값
	...
	private String thumbnailViewFileName6s	= "";		// 구간점프 이미지 파일명
