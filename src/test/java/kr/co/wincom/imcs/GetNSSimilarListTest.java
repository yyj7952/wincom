...
public class GetNSSimilarListTest
{
   ...
   @Test
   public void test_getNSContList() throws Exception
   {
	   test_run("getNSSimilarListTestCase_all.xlsx", "log/getNSSimilarListTestCase_all.log");
   }
   ...
   public void test_run(String preadFilePath, String  pwriteFilePath, int iRowNo ) throws Exception
   {
	   ...
	   for( int rowindex = 0 ; rowindex < rows; rowindex++){
	       ...
	       if( rowindex == 0 ){
	    	   ...
	    	   request.param("CMD", "getNSSimilarList");
	           for( int columnindex = 0; columnindex < cells; columnindex++ ){
	        	   String value = rowCellValue(row, columnindex);
	               if( columnindex == 0 ){
	            	   caseTitle = value;
...
//				assertThat(mvcResult.getResponse().getContentAsString(), startsWith(caseResult));
				...
				logBuffer.append("=========== getNSSimilarList " + caseTitle + " start!! ==========" + "\r\n");
				...
				logBuffer.append("=========== getNSSimilarList " + caseTitle + " end!! ==========" + "\r\n\r\n");
