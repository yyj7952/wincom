...
public class GetNSRepositedTest
{
   ...
   @Test
   public void test_getNSReposited() throws Exception
   {
	   test_run("getNSRepositedTestCase_all.xlsx", "log/getNSRepositedTestCase_all.log");
   }
   ...
   public void test_run(String preadFilePath, String  pwriteFilePath, int iRowNo ) throws Exception
   {
	   ...
	   for( int rowindex = 0 ; rowindex < rows; rowindex++){
	       ...
	       if( rowindex == 0 ){
	    	   ...
	    	   request.param("CMD", "getNSReposited");
	           for( int columnindex = 0; columnindex < cells; columnindex++ ){
	        	   String value = rowCellValue(row, columnindex);
	               if( columnindex == 0 ){
	            	   caseTitle = value;
...
//				assertThat(mvcResult.getResponse().getContentAsString(), startsWith(caseResult));
				...
				logBuffer.append("=========== getNSReposited " + caseTitle + " start!! ==========" + "\r\n");
				...
				logBuffer.append("=========== getNSReposited " + caseTitle + " end!! ==========" + "\r\n\r\n");
