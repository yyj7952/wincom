...
public class RmNSAllFavorRequestVO extends NoSqlLoggingVO implements Serializable
{
	...
	********************************************************************/
	...
	public RmNSAllFavorRequestVO(){}
	
	
	public RmNSAllFavorRequestVO(String szParam) {
		...
		//RmNSAllFavorController.saId = paramMap.get("sa_id");
		//RmNSAllFavorController.stbMac = paramMap.get("stb_mac");
