...
public class GetNSGuideVodTest
{
   ...
   @Test
   public void test_getNSGuideVod() throws Exception
   {
	   test_run("getNSGuideVodTestCase_all.xlsx", "log/getNSGuideVodTestCase_all.log");
   }
   ...
   public void test_run(String preadFilePath, String  pwriteFilePath, int iRowNo ) throws Exception
   {
	   ...
	   for( int rowindex = 0 ; rowindex < rows; rowindex++){
	       ...
	       if( rowindex == 0 ){
	    	   ...
	    	   request.param("CMD", "getNSGuideVod");
	           for( int columnindex = 0; columnindex < cells; columnindex++ ){
	        	   String value = rowCellValue(row, columnindex);
	               if( columnindex == 0 ){
	            	   caseTitle = value;
...
//				assertThat(mvcResult.getResponse().getContentAsString(), startsWith(caseResult));
				...
				logBuffer.append("=========== getNSGuideVod " + caseTitle + " start!! ==========" + "\r\n");
				...
				logBuffer.append("=========== getNSGuideVod " + caseTitle + " end!! ==========" + "\r\n\r\n");
