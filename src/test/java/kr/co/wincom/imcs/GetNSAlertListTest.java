...
public class GetNSAlertListTest
{
   ...
   @Test
   public void test_getNSAlertList() throws Exception
   {
	   test_run("getNSAlertListTestCase_all.xlsx", "log/getNSAlertListTestCase_all.log");
   }
   ...
   public void test_run(String preadFilePath, String  pwriteFilePath, int iRowNo ) throws Exception
   {
	   ...
	   for( int rowindex = 0 ; rowindex < rows; rowindex++){
	       ...
	       if( rowindex == 0 ){
	    	   ...
	    	   request.param("CMD", "getNSAlertList");
	           for( int columnindex = 0; columnindex < cells; columnindex++ ){
	        	   String value = rowCellValue(row, columnindex);
	               if( columnindex == 0 ){
	            	   caseTitle = value;
...
//				assertThat(mvcResult.getResponse().getContentAsString(), startsWith(caseResult));
				...
				logBuffer.append("=========== getNSAlertList " + caseTitle + " start!! ==========" + "\r\n");
				...
				logBuffer.append("=========== getNSAlertList " + caseTitle + " end!! ==========" + "\r\n\r\n");
