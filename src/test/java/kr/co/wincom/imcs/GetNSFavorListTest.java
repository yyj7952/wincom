...
public class GetNSFavorListTest
{
   ...
   @Test
   public void test_getNSFavorList() throws Exception
   {
	   test_run("getNSFavorListTestCase_all.xlsx", "log/getNSFavorListTestCase_all.log");
   }
   ...
   public void test_run(String preadFilePath, String  pwriteFilePath, int iRowNo ) throws Exception
   {
	   ...
	   for( int rowindex = 0 ; rowindex < rows; rowindex++){
	       ...
	       if( rowindex == 0 ){
	    	   ...
	    	   request.param("CMD", "getNSFavorList");
	           for( int columnindex = 0; columnindex < cells; columnindex++ ){
	        	   String value = rowCellValue(row, columnindex);
	               if( columnindex == 0 ){
	            	   caseTitle = value;
...
//				assertThat(mvcResult.getResponse().getContentAsString(), startsWith(caseResult));
				...
				logBuffer.append("=========== getNSFavorList " + caseTitle + " start!! ==========" + "\r\n");
				...
				logBuffer.append("=========== getNSFavorList " + caseTitle + " end!! ==========" + "\r\n\r\n");
