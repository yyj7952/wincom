...
public class RmNSAlertRequestVO extends NoSqlLoggingVO implements Serializable
{
	...
	********************************************************************/
	...
	public RmNSAlertRequestVO(){}
	
	
	public RmNSAlertRequestVO(String szParam) {
		...
		//RmNSAlertController.saId = paramMap.get("sa_id");
		
		//RmNSAlertController.stbMac = paramMap.get("stb_mac");
