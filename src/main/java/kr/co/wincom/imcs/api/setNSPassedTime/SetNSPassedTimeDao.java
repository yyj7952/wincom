...
@Repository
public interface SetNSPassedTimeDao {
	...
	// 링크 여부 조회1 (PT_VO_SET_TIME_PTT_NSC)
	public Integer getLinkChkNsc(SetNSPassedTimeRequestVO paramVO);
	public Integer getLinkChkNsc2(SetNSPassedTimeRequestVO paramVO);
	...
	// 2020.03.13 - 모바일 아이들나라 관련 쿼리
	public HashMap<String, String> chkCharBook(SetNSPassedTimeRequestVO paramVO);

	public Integer chkParentCnt(SetNSPassedTimeRequestVO paramVO);

	public Integer getLinkChkNscKids(SetNSPassedTimeRequestVO paramVO);
	
	public int updateSetTimeKids(SetNSPassedTimeRequestVO paramVO);
	
	public int insertSetTimeKids(SetNSPassedTimeRequestVO paramVO);
	
	public int insertSetWatchTime(SetNSPassedTimeRequestVO paramVO);
}
