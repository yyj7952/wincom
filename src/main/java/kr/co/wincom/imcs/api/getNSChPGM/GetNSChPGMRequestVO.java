...
public class GetNSChPGMRequestVO  extends NoSqlLoggingVO implements Serializable {
	/********************************************************************
...
//    private String svcId		= "";
    ...
    public GetNSChPGMRequestVO(){}
    
    public GetNSChPGMRequestVO(String szParam){
		...
		if(!commonService.getValidParam(this.requestTime, 10, 10, 3))
		{
			throw new ImcsException();
		}
