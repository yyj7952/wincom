...
public class GetNSMainPageTest
{
   ...
   @Test
   public void test_getNSMainPage() throws Exception
   {
	   test_run("getNSMainPageTestCase_all.xlsx", "log/getNSMainPageTestCase_all.log");
   }
   ...
   public void test_run(String preadFilePath, String  pwriteFilePath, int iRowNo ) throws Exception
   {
	   ...
	   for( int rowindex = 0 ; rowindex < rows; rowindex++){
	       ...
	       if( rowindex == 0 ){
	    	   ...
	    	   request.param("CMD", "getNSMainPage");
	           for( int columnindex = 0; columnindex < cells; columnindex++ ){
	        	   String value = rowCellValue(row, columnindex);
	               if( columnindex == 0 ){
	            	   caseTitle = value;
...
//				assertThat(mvcResult.getResponse().getContentAsString(), startsWith(caseResult));
				...
				logBuffer.append("=========== getNSMainPage " + caseTitle + " start!! ==========" + "\r\n");
				...
				logBuffer.append("=========== getNSMainPage " + caseTitle + " end!! ==========" + "\r\n\r\n");
