...
public class AuthorizePViewRequestVO  extends NoSqlLoggingVO implements Serializable {
	/********************************************************************
	...
	********************************************************************/
    ...
    public AuthorizePViewRequestVO(){}
    
    public AuthorizePViewRequestVO(String szParam){
		...
		if( szTemp.indexOf("sa_id") == -1 || szTemp.indexOf("stb_mac") == -1
				...
				|| szTemp.indexOf("app_type") == -1 || szTemp.indexOf("defin_flag") == -1 )
		{
		...
		//AuthorizePViewController.saId = paramMap.get("sa_id");
		
		//AuthorizePViewController.stbMac = paramMap.get("stb_mac");	
		
		if( paramMap.get("sa_id") == null || paramMap.get("stb_mac") == null
				|| paramMap.get("album_id") == null || paramMap.get("adaptive_type") == null 
				|| paramMap.get("base_gb") == null || paramMap.get("base_cd") == null
				|| paramMap.get("app_type") == null || paramMap.get("defin_flag") == null )
		{
			throw new ImcsException();
		}
		...
		if("1".equals(definFlag))		this.bitRate = "M1";
		if("2".equals(definFlag))		this.bitRate = "M2";
		if("".equals(definFlag))		this.bitRate = "M2";
