...
public class AuthorizePViewResultVO extends StatVO implements Serializable {
	private List<AuthorizePViewResponseVO> list;
	private List<AuthorizePlayIpVO> m3u8list;
	
	public List<AuthorizePViewResponseVO> getList() {
		return list;
	}

	public void setList(List<AuthorizePViewResponseVO> list) {
		this.list = list;
	}
	...
	public String toString() {
		...
		if(this.getList() != null && this.getList().size() > 0) {
			...
			for(AuthorizePViewResponseVO vo : this.getList()) {
				record.append(vo);
