...
nohup java -Dtempdb.config.path=/app/nosql/tempdb_history_consumer.conf -cp /app/nosql/tempdb-0.1.0-jar-with-dependencies.jar lguplus.kafkaConsumer.UserWatchTempdbHistory &
else
