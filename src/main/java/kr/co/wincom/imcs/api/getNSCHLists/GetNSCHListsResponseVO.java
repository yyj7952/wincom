...
public class GetNSCHListsResponseVO extends NoSqlLoggingVO implements Serializable {
	/********************************************************************
	 * getNSCHLists API 전문 칼럼(순서 일치)
	********************************************************************/
	private String serviceId			= "";	// 서비스 ID
    private String serviceName			= "";	// 서비스명
    private String serviceEngName		= "";	// 서비스명(영문)
	...
	public String toString() {
		...
		sb.append(StringUtils.defaultString(this.getServiceName(), "")).append(ImcsConstants.COLSEP);
		sb.append(StringUtils.defaultString(this.getServiceEngName(), "")).append(ImcsConstants.COLSEP);
		...
		sb.append(StringUtils.defaultString(this.getPooqYn(), "")).append(ImcsConstants.COLSEP);
