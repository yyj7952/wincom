...
public class RmNSFavoriteRequestVO extends NoSqlLoggingVO implements Serializable {
	...
	********************************************************************/
	...
	private String contsId		= "";	// [20] 영화 ID (앨범ID1\b앨범ID2\b앨범ID3(다중삭제 시 배열))
	...
	********************************************************************/
	...
	private String contentId	= "";	// contsId를 split하여 사용하기 위하여 만듬
	private String ivMimsChk    = "";
	
	private String pid			= "";
	private String resultCode	= "";
	
	
	public RmNSFavoriteRequestVO(){}
	
	
	public RmNSFavoriteRequestVO(String szParam) {
		...
		//RmNSFavoriteController.saId = paramMap.get("sa_id");
		//RmNSFavoriteController.stbMac = paramMap.get("stb_mac");
	...
	public String getIvMimsChk() {
		return ivMimsChk;
	}


	public void setIvMimsChk(String ivMimsChk) {
		this.ivMimsChk = ivMimsChk;
	}
