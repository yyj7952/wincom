...
public class GetNSFavorListResponseVO implements Serializable
{
	private static final long serialVersionUID = 170116096565178079L;
	//= 무중단 일경우 : SUBSCRIPTION_YN == ""
	
	private String idx				  = "";		// 번호 (찜목록 리스트 번호)
	private String adiAlbumId		  = "";		// 앨범ID (ID)
	private String contentsName		  = "";		// 앨범이름 (NAME)
	...
	private String contsLevel		  = "";		// 카테고리 레벨 정보(1, 2, 3, 4) (CAT_LEVEL)
	...
	private String catGb              = "";					// authYn 무조건 연령 인증??
	...
	public String toString() {
		...
		sb.append(StringUtil.replaceNull(this.adiAlbumId, "")).append(ImcsConstants.COLSEP);
		sb.append(StringUtil.replaceNull(this.contentsName, "")).append(ImcsConstants.COLSEP);
		...
		sb.append(StringUtil.replaceNull(this.contsLevel, "")).append(ImcsConstants.COLSEP);
		...
		sb.append(StringUtil.replaceNull(this.thumbnailFileUrl, "")).append(ImcsConstants.COLSEP);
		...
		sb.append(StringUtil.replaceNull(this.visitFlag, "")).append(ImcsConstants.COLSEP);
