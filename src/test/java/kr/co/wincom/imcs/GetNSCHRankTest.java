...
public class GetNSCHRankTest
{
   ...
   @Test
   public void test_getNSCHRank() throws Exception
   {
	   test_run("getNSCHRankTestCase_all.xlsx", "log/getNSCHRankTestCase_all.log");
   }
...
//				assertThat(mvcResult.getResponse().getContentAsString(), startsWith(caseResult));
				...
				logBuffer.append("=========== getNSCHRank " + caseTitle + " start!! ==========" + "\r\n");
				...
				logBuffer.append("=========== getNSCHRank " + caseTitle + " end!! ==========" + "\r\n\r\n");
