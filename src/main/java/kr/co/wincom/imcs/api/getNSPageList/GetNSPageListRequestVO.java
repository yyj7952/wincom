...
public class GetNSPageListRequestVO extends NoSqlLoggingVO implements Serializable
{
	...
	********************************************************************/
	...
	public GetNSPageListRequestVO(){}
	
	public GetNSPageListRequestVO(String szParam){
		...
		//GetNSPageListController.saId = paramMap.get("sa_id");
		
		//GetNSPageListController.stbMac = paramMap.get("stb_mac");
		...
		if((this.saId.equals("") && this.stbMac.equals("")) || this.catId.equals("undef"))
			throw new ImcsException();
