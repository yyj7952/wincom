...
public class GetNSCatBillInfoRequestVO  extends NoSqlLoggingVO implements Serializable {
	/********************************************************************
	...
	********************************************************************/
    ...
    public GetNSCatBillInfoRequestVO(){}
    
    public GetNSCatBillInfoRequestVO(String szParam){
		...
		for(int i = 0; i < arrStat.length; i++){
			...
			if(nStr > 0) {
				...
				if(key.toLowerCase().equals("album_id"))		this.multiAlbumId = value;
			}
		}
		
		//GetNSCatBillInfoController.saId = paramMap.get("sa_id");
		//GetNSCatBillInfoController.stbMac = paramMap.get("stb_mac");
